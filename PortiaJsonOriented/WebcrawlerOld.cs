...
//            #endregion
//        }
//        public async Task<Core.DTO.PortiaResponse> StartAsync(Core.DTO.PortiaRequest request)
//        {
...
//            {
//                tasks.Add(item.Name, new JArray());
//            }
...
//                    foreach (PortiaTask task in request.Jobs)
//                    {
...
//                            continue;
//                        }
//                        tasks[task.Name].Add(taskObject);
...
//            }
//            Core.DTO.PortiaResponse response = new Core.DTO.PortiaResponse
//            {
...
//            return false;
//        }
//        private static bool ContainsAnyRootItems(string html, Core.DTO.PortiaRequest request)
//        {
//            HtmlDocument htmlDoc = new HtmlDocument();
//            htmlDoc.LoadHtml(html);
//            HtmlNode documentNode = htmlDoc.DocumentNode;
//            foreach (var datum in request.Jobs)
//            {
